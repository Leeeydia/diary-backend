...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResultData<Void>> handleMethodNotSupported(HttpRequestMethodNotSupportedException e) {
        log.warn("Method not supported: {}", e.getMessage());
        return ResponseEntity
                .status(405)
                .body(ResultData.fail(405, "METHOD_NOT_ALLOWED", "지원하지 않는 HTTP 메서드입니다."));
    }
